...
/**
 * Replicates Webflow IX2 "Scroll Into View" animations.
 *
 * Important: when `data-reveal-distance="0"` we ONLY animate opacity. The flower
 * images already have a CSS `transform: rotate(...)` and writing `y: 0` via GSAP
 * would clobber that rotation. CSS keyframes (defined in globals.css) handle the
 * gentle sway loop on the flowers and preserve their base rotation.
 */
