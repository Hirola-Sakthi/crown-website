...
/**
 * Contact page — exact replica of https://lovio.webflow.io/contact
 *
 * Structure (from the scraped HTML, in order):
 *   1. .section.first  →  .contact form block + flower decorations
 *   2. .section        →  3-column Address / Email / Phone info grid
 *
 * The site-wide Footer (Instagram + footer columns) is rendered globally in App.jsx.
 *
 * Critical Webflow node IDs that govern the form grid:
 *   #w-node-_4b026346-...c8f3...  →  Message field, grid-area: span 1 / span 2 (full row)
 *   #w-node-e6cfd1ab-...ac06...   →  Submit button, full row + justify-self: center
 */
        ...
        <div className="content">
          <div className="w-layout-grid grid-3-columns">
            ...
            <div className="info" data-reveal data-reveal-delay="0.15">
              ...
              <p className="paragraph-info">
                Email Us At:<br />
                <a href="mailto:info@yoursite.com" className="link-text">info@yoursite.com</a>
              </p>
            </div>
            <div className="info" data-reveal data-reveal-delay="0.3">
              ...
              <p className="paragraph-info">
                Call Us At:<br />
                <a href="tel:800-123-4567" className="link-text">800-123-4567</a>
              </p>
            </div>
          </div>
        </div>
