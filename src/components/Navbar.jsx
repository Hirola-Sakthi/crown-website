...
/**
 * Cleaned-up navbar — no A/B/C dropdowns, no unused links, no cart.
 * Final menu: Home · About | LOGO | Services · Contact
 *
 * Layout uses Webflow's existing `.grid-navbar` / `.block-navbar` classes
 * so spacing, font, and mobile collapse stay consistent with the original.
 */
  ...
  return (
    ...
    >
      <Link to="/" className="brand-mobile w-nav-brand">
        <img src="/images/logo.svg" loading="lazy" alt="Lovio" className="logo-mobile" />
      </Link>
      ...
      >
        <div className="w-layout-grid grid-navbar">
          ...
          <Link to="/" className="brand w-nav-brand">
            <img src="/images/logo.svg" loading="lazy" alt="Lovio" className="logo" />
          </Link>
